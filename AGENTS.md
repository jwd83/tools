...
## Key Files
- `index.html`: Main page, styles, and tool list data.
- `favicon.svg`: Site favicon (hammer icon).
- `CNAME`: Custom domain configuration for GitHub Pages.

## How To Add A Tool
1. Add a new object to the `tools` array in `index.html`.
2. Include `title`, `description`, and `link`.
3. Keep descriptions short and action-focused.

## Experimental Tools
- Add unstable projects to `experimentalTools` in `index.html`.
